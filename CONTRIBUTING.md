...
have its own set of tests, be formatted correctly and be consistent with the overall Jrpip vision.
...
If you have never contributed to Jrpip, or your copyright ownership has changed, you must first create a pull request that has
...
Apache 2.0 license for the purpose of contribution to Jrpip. Negotiating such authorization and administering 
